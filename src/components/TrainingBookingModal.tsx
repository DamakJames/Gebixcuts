...
export const TrainingBookingModal: React.FC<TrainingBookingModalProps> = ({ isOpen, onClose, preselectedCourse }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10 overflow-y-auto animate-fadeIn">
      ...
      {/* Modal Box */}
      <div className="relative w-full max-w-3xl bg-[#111116] border border-[#E6AF2E]/40 rounded-3xl overflow-hidden shadow-[0_0_60px_rgba(230,175,46,0.25)] z-10 animate-scaleUp my-auto">
        {/* Header Bar */}
        <div className="flex items-center justify-between px-6 py-5 bg-[#16161E] border-b border-white/10">
          <div className="flex items-center space-x-3.5">
            <div className="w-11 h-11 rounded-2xl bg-[#E6AF2E]/20 border border-[#E6AF2E] flex items-center justify-center text-[#E6AF2E]">
            ...
            <div>
              ...
              <p className="text-xs text-[#E6AF2E] uppercase tracking-wider font-bold">
          ...
          <button 
            onClick={handleResetAndClose}
            className="p-2.5 rounded-full bg-white/5 hover:bg-[#E6AF2E]/20 text-gray-400 hover:text-[#E6AF2E] transition-colors"
          >
            <X className="w-6 h-6" />
          </button>
        </div>
          ...
          {submitted ? (
            <div className="text-center py-10 space-y-6 animate-fadeIn">
              ...
              <div className="space-y-2">
                <h4 className="font-heading text-2xl sm:text-3xl font-extrabold text-white">Redirecting to WhatsApp!</h4>
              ...
              <div className="bg-[#16161E] rounded-2xl p-6 border border-white/10 max-w-md mx-auto space-y-3 text-left">
                ...
                <div className="flex items-center gap-3 text-sm text-white font-semibold break-all">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
                <button 
                  ...
                  className="px-8 py-3.5 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-black font-heading font-extrabold text-sm transition-all shadow-[0_0_25px_rgba(37,211,102,0.4)] flex items-center justify-center gap-2"
                >
                ...
                <button 
                  onClick={handleResetAndClose}
                  className="px-8 py-3.5 rounded-xl bg-white/10 text-white font-heading font-bold text-sm hover:bg-white/20 transition-all border border-white/15"
                >
                  Return to Website
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-[#181820] border border-white/15 rounded-xl px-4 py-3.5 text-sm text-white placeholder-gray-500 focus:border-[#E6AF2E] transition-colors"
                  />
                </div>
                <div>
                  <label className="block text-xs uppercase tracking-wider font-bold text-gray-300 mb-2">
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-[#181820] border border-white/15 rounded-xl px-4 py-3.5 text-sm text-white focus:border-[#E6AF2E] transition-colors"
                >
                      ...
                      >
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            <span className={`text-xs font-bold uppercase tracking-wider ${isSelected ? 'text-[#E6AF2E]' : 'text-gray-400'}`}>
                              {plan.title.split(' — ')[0]}
                            </span>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-[#181820] border border-white/15 rounded-xl px-4 py-3.5 text-sm text-white placeholder-gray-500 focus:border-[#E6AF2E] transition-colors resize-none"
                />
              </div>

              {/* WhatsApp Note & Submit Button */}
              <div className="space-y-4 pt-2">
                <div className="p-4 rounded-2xl bg-[#25D366]/10 border border-[#25D366]/30 flex items-center gap-3.5 text-xs sm:text-sm text-gray-200">
                  <div className="w-10 h-10 rounded-xl bg-[#25D366]/20 border border-[#25D366] flex items-center justify-center shrink-0 text-[#25D366]">
                    <Send className="w-5 h-5" />
                  </div>
                  <div>
                    <span className="font-bold text-white block">Instant WhatsApp Confirmation</span>
                    <span>Submitting this form will open a direct WhatsApp chat with our studio desk (<strong className="text-[#25D366]">+234 904 212 3833</strong>) with your enrollment pre-filled!</span>
                  </div>
                </div>

                <button 
                  type="submit"
                  className="w-full py-4 rounded-xl bg-[#E6AF2E] text-black font-heading font-extrabold text-base hover:bg-[#F5C542] transition-all flex items-center justify-center space-x-2.5 shadow-[0_0_30px_rgba(230,175,46,0.4)] group"
                >
